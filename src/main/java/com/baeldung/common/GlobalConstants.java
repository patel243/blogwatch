...
public class GlobalConstants {
    ...
    public static final String givenAllArticles_whenAnArticleLoads_thenTheMetaDescriptionExists = "givenAllArticles_whenAnArticleLoads_thenAMetaDescriptionExists";
