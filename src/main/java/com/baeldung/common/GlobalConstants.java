...
public class GlobalConstants {
    ...
    public static final String givenAllTheArticles_whenAnArticleLoads_thenTheArticleDoesNotContainUnnecessaryLabels = "givenAllTheArticles_whenAnArticleLoads_thenTheArticleDoesNotContainUnnecessaryLabels";
