...
| Sr. | Test Name |
| --- | --------- |
| 1 | **givenOnTheRwSTeamOptInPage_whenTheGetAccessButtonIsClicked_thenTheOptInsPopupsWorkFine** <br/><br/>every 30 minutes<br/><br/>This test verifies optin popups in the following article - http://www.baeldung.com/rest-with-spring-for-teams-opt-in |
...
| 33 | **givenTheGitHubModuleReadme_theArticlesLinkedInTheGitHubMouduleLinkForwardTotheSameGitHubModule** <br/><br/> monthly <br/><br/> This test verifies that articles linked in GitHub READMEs link forward to the same GitHub module. As of now, the test scans only tutorials(https://github.com/eugenp/tutorials) repo.|
