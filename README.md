...
| 37 | **givenTheGitHubModuleReadme_theArticlesLinkedInTheGitHubMouduleLinkForwardTotheSameGitHubModule** <br/><br/> monthly <br/><br/> This test verifies that articles linked in GitHub READMEs link forward to the same GitHub module. As of now, the test scans only tutorials(https://github.com/eugenp/tutorials) repo.|
| 38 | **givenOnTheCoursePage_whenThePageLoads_thenAGeoIPApiProviderWorks** <br/><br/> daily <br/><br/> This test loads http://baeldung.com/learn-spring-security-course/ and verifies that any of the following messages are logged in the browser console: </br>VAT Calc Notice: geoIP API provider is set to ipinfo.io</br>VAT Calc Notice: geoIP API provider is set to ipapi.com|
| 39 | **givenOnTheCoursePage_whenThePageLoadsInEUCountry_thenTheVATPricesAreShown** <br/><br/> daily <br/><br/> This test loads http://baeldung.com/learn-spring-security-course/ with EU proxy and verifies that VAT prices are available|
