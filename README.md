...
| 37 | **givenTheGitHubModuleReadme_theFileContainsCorrectLinks** <br/><br/> monthly <br/><br/> This test verifies that articles linked in GitHub READMEs link forward to the same GitHub module. As of now, the test scans only tutorials(https://github.com/eugenp/tutorials) repo.|
